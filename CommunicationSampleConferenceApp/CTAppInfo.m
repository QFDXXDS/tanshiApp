...
//  VidyoSample
//
//  Created by Xianxiangdaishu on 2017/12/15.
...
+ (NSString *)appVersion {
    ...
    NSString *s = [NSString stringWithFormat:@"%@",[ [self infoDic] objectForKey:@"CFBundleShortVersionString"]] ;
    return s;
}

+ (NSString *)appBundleId {
    
    NSString *s = [ [self infoDic] objectForKey:@"CFBundleIdentifier"] ;
    return s ;
}
...
+ (NSString *)terminalOS {
    ...
    NSString *s = [NSString stringWithFormat:@"IOS %@",[UIDevice currentDevice].systemVersion] ;
    return s;
}
